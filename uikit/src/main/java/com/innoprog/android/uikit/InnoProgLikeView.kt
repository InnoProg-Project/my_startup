...
class InnoProgLikeView @JvmOverloads constructor(
    ...
    init {
        ...
        attrs?.applyStyleable(context, R.styleable.LikeCustomView) {
            ...
            this@InnoProgLikeView.setBackgroundResource(R.drawable.rectangle_with_corners)

            if (getBoolean(R.styleable.LikeCustomView_liked, false)) {

                likeIcon.setColorFilter(context.getColor(R.color.like_color))
                this@InnoProgLikeView.background.setTint(context.getColor(R.color.like_background_color))
                ...
                this@InnoProgLikeView.background.setTint(context.getColor(R.color.background_secondary))
                liked = false
            }
